---
layout:     post
title:      Agent Harness(2):的两个杀手级特性：CodeAct 与 Handoff
...
> 上一篇讲了 [Agent Harness 的核心定位](blog1.1-dev-autonomy-build2026.md)——框架级执行层。这篇深入两个**改变交互范式**的能力：CodeAct 减少往返，Handoff 实现动态路由。
